...
var Taixiu = function(){
    ...
    this.gameOver = function() {
        ...
        // Kết quả luôn theo lựa chọn của người chơi
        this.ketQua = {
            dice1: 1, // giá trị bất kỳ
            dice2: 2, // giá trị bất kỳ
            dice3: 3, // giá trị bất kỳ
            result: seft.soNguoiChonTai > 0 ? 'tai' : 'xiu' // Kết quả theo số người chọn
        };
    
        io.sockets.emit('gameOver', this.ketQua);
        console.log(JSON.stringify(this.ketQua));
    
        let idWin = this.ketQua.result === 'tai' ? seft.idChonTai : seft.idChonXiu;
        idWin.forEach((data) => {
    ...
    this.gameRandomResult = function(){
        ...
        return {
            ...
            dice2: 2, // giá trị bất kỳ
            dice3: 3, // giá trị bất kỳ
            result: this.soNguoiChonTai > 0 ? 'tai' : 'xiu' // Kết quả theo số người chọn
        };
    };
}
